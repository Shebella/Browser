...
(function($)
{
    ...
    $.itriCSSJsonParser_acc = function(settings){
       ...
       function buildListItem(itemObj, i){
           ...
           trObj.attr('id', itemObj.bucketId);
           ...
           var actObj = $('<a href="files?bucket=' + itemObj.bucketName + '"></a>');
           actObj.html(itemObj.bucketName);
           ...
           sizetd.html(itemObj.objectCount);
           trObj.append(sizetd);
            
           //usage
           var lmtd = $(tdStr);
           lmtd.html(itemObj.objectCount);
