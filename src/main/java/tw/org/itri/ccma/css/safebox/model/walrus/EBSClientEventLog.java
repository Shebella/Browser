 ...
 */
@Entity
@Table(name = "opt_log", schema = "public")
public class EBSClientEventLog {

	public static final String DEFAULT_INSTANCE_ID = "dummy";

	public static enum ACTION_CODE {
		CREATE("Create"), DELETE("Delete"), MODIFY("Modify"), RENAME("Rename"), BACKUP_COPY("BackupCopy"), GET_REMOTELY(
				"GetRemotely"), DELETE_LOCALLY("DeleteLocally");
		private String text;
	...
	public static enum FOLDER_FLAG {
		FOLDER("true"), NOT_FOLDER("false");
		private String text;

		FOLDER_FLAG(String text) {
			this.text = text;
		}
	...
	public EBSClientEventLog() {
	}

	public EBSClientEventLog(long sync_id) {
		this.syncId = sync_id;
	}
